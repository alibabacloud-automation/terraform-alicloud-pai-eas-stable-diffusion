...
用于在阿里云上创建 PAI-EAS 服务以部署 Stable Diffusion WebUI 的 Terraform 模块。该模块实现了 [PAI 部署多形态的 Stable Diffusion WebUI 服务](https://www.aliyun.com/solution/tech-solution/pai-eas) 解决方案，涉及 PAI、NAS、NAT 网关等相关基础设施组件的创建和部署，提供完整的 AI 图像生成服务。
...
* [完整示例](https://github.com/alibabacloud-automation/terraform-alicloud-pai-eas-stable-diffusion/tree/main/examples/complete)
